...
| 002a | custom-diagnostic-sink | comparison | Given a narrow custom sink with a no-op default, when bootstrap/finalizer diagnostics are emitted concurrently, then structured fields arrive without output or races by default | PENDING | logging, api, noop |
